...
class _RestClient implements RestClient {
  ...
  @override
  Future<UsersDto> getUsers({int? limit}) async {
    const _extra = <String, dynamic>{};
    ...
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<UsersDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<UserDto> getMyUser({int? delayMilliseconds}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'delay': delayMilliseconds};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
  ...
  @override
  Future<UserDto> getMyUserAuthorized({required String bearerToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
